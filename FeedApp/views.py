...
@login_required
def friends(request):
    # to Get the admin_profile and user_profile to create the first relationship
    ...
    # with the admin of the website (so the admins is friends with everyone)
